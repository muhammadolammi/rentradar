...
VALUES ( $1, $2, $3, $4, $5,$6)
RETURNING id, user_id, listing_id, sent_at, contact, contact_method, status, subject, body
`
...
SELECT id, user_id, listing_id, sent_at, contact, contact_method, status, subject, body FROM notifications
